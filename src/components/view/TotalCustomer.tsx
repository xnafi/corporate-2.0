...
const TotalCustomer = () => {
  ...
  return (
    <div className="container mx-auto p-6 bg-[#0d0f1b] text-white rounded-xl flex flex-col sm:flex-row gap-10 md:gap-16 lg:gap-28 justify-center items-center mt-8 mb-16">
