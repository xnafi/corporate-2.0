...
const Banner = () => {
  return (
    <section className="max-w-[1440px] mx-auto px-4 lg:px-12 py-4 lg:py-8">
      {/* Banner Section */}
      ...
      <div className=" text-center space-y-4 flex flex-row justify-between items-center">
        <p className="text-gray-600 text-sm">
          <span className="font-semibold underline text-black text-lg">Join 27,000+</span> companies who've reached
        </p>
        {/* Logos */}
        <div className="flex justify-center items-center space-x-8 flex-wrap">
          <Image src="https://i.postimg.cc/Y99C8DF9/Google-2015-logo-svg.png" alt="Google" width={100} height={50} />
          <Image src="https://i.postimg.cc/7PjSGSv7/3374985-56876.jpg" alt="Hello" width={100} height={50} />
          <Image src="https://i.postimg.cc/fTCz9f5n/webflow7029.jpg" alt="Webflow" width={100} height={50} />
          <Image src="https://i.postimg.cc/HLy1Bw0L/Vine-Logo-2013.png" alt="Vine" width={100} height={50} />
          <Image src="https://i.postimg.cc/7hXFfm4K/Getarounds.png" alt="Getaround" width={100} height={50} />
        </div>
      </div>
    </section>
  );
