  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        <h2 className="text-xs sm:text-sm text-orange-500 uppercase tracking-wide">Our Team</h2>
        ...
        <p className="text-gray-600 mt-2 text-xs sm:text-sm md:text-base">
          We are dedicated to providing reliable clinical care, guaranteeing the highest standards of trustworthiness.
        </p>
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="px-2 sm:px-4">
                ...
                >
                  ...
                  {member.social && (
                    <div className="absolute top-4 right-4 flex flex-col space-y-2">
                      <a href="#" className="bg-white p-2 rounded-full shadow hover:bg-gray-100">
                ...
                <div className="text-center mt-4">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base">{member.name}</p>
                </div>
              </div>
            ))}
          </Slider>
