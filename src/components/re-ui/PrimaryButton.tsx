...
export default function PrimaryButton({
  ...
  return (
    <button className="border hover:scale-95 duration-300 relative group cursor-pointer text-[#1a73e8] overflow-hidden  h-14 w-48 rounded-md bg-[#1a73e8] p-2 flex justify-center items-center font-semibold hover:bg-[#e8f0fe]">
      {/* Animated Circles */}
      ...
      {/* Optional Custom Icon (e.g., FaPlay) */}
